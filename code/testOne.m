function [imagename, test1_acc, test1_dsc, test1_predImage, gtimage, predOverlayt1, gtOverlayt1] = testOne(cmap, brainwebFolder, net, test1_Idx, t1Test, t2Test, pdTest, gtTest, slicNum, compactness, featureMode, MiniBatchSize)
...
[test1_L, test1_N] = superpixels(test1_t1, slicNum, 'Compactness', compactness, 'NumIterations', 1);
...
[test1_predlbl, test1_predImage] = createPredImage(test1_pred, test1_L, test1_N);
