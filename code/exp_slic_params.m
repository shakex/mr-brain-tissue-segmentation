% Experiment
% dataset: brainweb
% slic+lstm, superpixel params exp
...
[test1_L, test1_N] = superpixels(test1_t1, 1000, 'Compactness', 10, 'NumIterations', 1);
...
gtt = imread('/Users/shake/Documents/master/project/MRBrainSeg/res_ppt/gt.bmp');
% display superpixel graph
dispSuperpixelGraph(gtt, test1_L, test1_N, test1_G, 4);
...
% pixelLabelColorbar(cmap, classes);
% imwrite(test1_predImage, 'C:\Users\shake\Desktop\ר����ͼ\7-2.jpg');
% imwrite(label2rgb(double(test1_gt),cmap), 'C:\Users\shake\Desktop\ר����ͼ\7-1.jpg');
